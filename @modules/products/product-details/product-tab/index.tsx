...
export default function ProductTabs() {
  ...
  return (
    <div className="mt-10 mb-10">
      ...
      {/* ==== DESCRIPTION ==== */}
      <div className="border border-gray-200 mb-3 rounded-md overflow-hidden bg-white shadow-sm">
        <button
          onClick={() => toggleTab(0)}
        ...
        <div
          className={`transition-all duration-500 ease-in-out overflow-hidden ${
            openIndex === 0 ? "max-h-[600px] px-6 pb-5 border-t border-gray-100" : "max-h-0"
          }`}
        >
          <p className="text-[15px] text-[#555] leading-relaxed pt-4">
            Crafted with precision and care, this product combines durability with
            modern aesthetics. Perfect for daily use or professional wear, its
            material ensures long-lasting quality while maintaining comfort and
      ...
      <div className="border border-gray-200 mb-3 rounded-md overflow-hidden bg-white shadow-sm">
        ...
        <div
          className={`transition-all duration-500 ease-in-out overflow-hidden ${
            openIndex === 1 ? "max-h-[600px] px-6 pb-5 border-t border-gray-100" : "max-h-0"
          }`}
        >
      ...
      <div className="border border-gray-200 rounded-md overflow-hidden bg-white shadow-sm">
        ...
        <div
          className={`transition-all duration-500 ease-in-out overflow-hidden ${
            openIndex === 2 ? "max-h-[800px] px-6 pb-6 border-t border-gray-100" : "max-h-0"
          }`}
        >
          <div className="pt-5">
            <div className="mb-5">
