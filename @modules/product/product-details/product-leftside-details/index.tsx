...
import { FaClock, FaExchangeAlt, FaFacebookF, FaFlag, FaHeart, FaLinkedinIn, FaPinterestP, FaTag, FaTwitter, FaWhatsapp } from 'react-icons/fa';

const ProductLeftSideContent = ({ product }: { product: ProductType }) => {
    return (
        <div>
...
export default ProductLeftSideContent;