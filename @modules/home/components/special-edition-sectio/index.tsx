...
const products: Product[] = [
  {
    ...
    discount: "-14%",
    thumbnail:
      "https://tasa.com.bd/wp-content/uploads/2024/05/DSC03126-800x800.jpg",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    discount: "-16%",
    thumbnail:
      "https://tasa.com.bd/wp-content/uploads/2024/06/DSC03988-800x800.jpg",
  },
  {
    id: 4,
...
export default function SpecialEditionSection() {
  ...
  return (
    <section className="relative px-4  bg-white w-full overflow-hidden">
      ...
      <div className="relative max-w-[96%] sm:max-w-7xl bg-[#F0F0F0] px-2 sm:px-4 py-4 mx-auto group rounded-lg">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 -left-4 sm:-left-10 z-30 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <button
            ref={prevRef}
            aria-label="Previous"
            className="swiper-button-prev w-10 h-10 sm:w-14 arrow sm:h-14 arrow flex items-center justify-center "
          >
        ...
        <div className="absolute top-1/2 -translate-y-1/2 -right-4 sm:-right-10 z-30 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <button
            ref={nextRef}
            aria-label="Next"
            className="swiper-button-next w-10 h-10 sm:w-14 arrow sm:h-14 arrow flex items-center justify-center "
          >
